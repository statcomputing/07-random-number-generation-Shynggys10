...
### In this exercise we are given the mixture of Normal distributions with unknown parameters of mean and variance. But we know their priors and the fact that priors are independent. We need to design an MCMC using the Gibbs sampling approach to estimate all 5 parameters.
